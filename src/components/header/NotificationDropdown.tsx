...
import { PaymentReceiptData, fetchPaymentReceipts } from "@/lib/paymentReceiptService";
  ...
  return (
    <div className="relative">
      ...
      >
        ...
        {pendingCount > 0 && (
          <span className="absolute -top-1 -right-1 inline-flex items-center justify-center px-2 py-1 text-xs font-bold leading-none text-white transform translate-x-1/2 -translate-y-1/2 bg-red-600 rounded-full min-w-[18px] h-5">
      ...
      <Dropdown
        ...
        className="fixed inset-x-4 top-20 mx-auto flex h-[400px] max-h-[70vh] w-full max-w-[320px] flex-col rounded-2xl border border-gray-200 bg-white p-3 shadow-theme-lg dark:border-gray-800 dark:bg-gray-dark sm:absolute sm:inset-x-auto sm:top-auto sm:left-auto sm:mx-0 sm:h-[480px] sm:max-h-none sm:w-[361px] sm:-right-[240px] lg:right-0"
      >
